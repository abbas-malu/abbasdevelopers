...
let usA1 = document.getElementById('unSelectRow1')
usA1.addEventListener('click',unSelectRow1)
...
let usA2 = document.getElementById('unSelectRow2')
usA2.addEventListener('click',unSelectRow2)
...
let usA3 = document.getElementById('unSelectRow3')
usA3.addEventListener('click',unSelectRow3)
...
let usA4 = document.getElementById('unSelectRow4')
usA4.addEventListener('click',unSelectRow4)

function unSelectRow4(){
  optArr4.forEach(function(element) {
    document.getElementById(element).checked = false
    // document.getElementById(element).removeAttribute('checked')
  })
...
rowBtn.addEventListener('click', function (event) {
  ...
  xhr.open('GET', `https://my.api.mockaroo.com/jsondata.json?key=${api_key}`, true);
